...
// };
	...
	_smallGroup = [ "B_soldier_TL_F", "B_medic_F", "B_soldier_F" ]; //Grupo pequeño de tres hombres para patrullas
	_LSVGroup = [ "B_soldier_TL_F", "B_medic_F", "B_soldier_F", "B_T_LSV_02_armed_F" ]; //Grupo de 3 hombres + LSV
	...
	[        //Grupo    //Punto de spawn //Son solo Inf? //Bando     //Tarea         //Piden refuerzos? //Dan apoyo a otros grupos?  //False si task es DEFEND/DEFEND_BASE
		...
		[ [  _smallGroup, "mZone_1", true, WEST ], [ "PATROL_AROUND" ], [true, true, true] ],
		[ [  _smallGroup, "mZone_1", true, WEST ], [ "PATROL" ], [true, true, true] ],

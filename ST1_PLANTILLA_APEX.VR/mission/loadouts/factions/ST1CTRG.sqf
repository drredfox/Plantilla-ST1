...
_commonRIFLE = _RHSHK416;
_commonRIFLEGL = _RHSHK416GL;
_commonPISTOL = _M9;
_commonSMG = _SMG;
_commonMG = _M249L;
_commonMARKSMAN = _SIG556K;
_commonSNIPER = _M200;
_commonAT = _AT4;
_specAT = _TitanAT;
_specAA = _TitanAA;
...
_marksmanMAGNIFIED = "optic_AMS_khk";
...
// =============================================================================
    ...
    case (_isMarksman): {
        ...
        ["primary", _marksmanMAGNIFIED] call _attachToWeapon;
    };

...
switch (_priority) do {
    case 0: { _details set [0, format ["(OPCIONAL) %1", (_details select 0)]]; };
    case 1: { _details set [0, format ["(SECUNDARIO) %1", (_details select 0)]]; }
};
...
[_side, _id, _ndetails, nil, false, 0, true, _taskType] call BIS_fnc_taskCreate;
